class TicTacToeCardGame {
    ...
    loadGameStateFromFirebase(gameState) {
        ...
        try {
            ...
            // If game just became active (new game started), hide result screen and show game
            // Only update display once to prevent infinite loops
            if (!wasGameActive && this.gameActive && this.gameMode === 'online') {
                const gameResultEl = document.getElementById('gameResult');
                const gameContainerEl = document.getElementById('gameContainer');
                
                // Only update if currently visible to avoid unnecessary DOM manipulation
